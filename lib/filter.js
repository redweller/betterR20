const SUB_HASH_PREFIX_LENGTH = 4;

const EVNT_VALCHANGE = "valchange";
const SOURCE_HEADER = "Source";
const TITLE_BTN_RESET = "Reset filters. SHIFT to reset everything.";

const PILL_STATE__IGNORE = 0;
const PILL_STATE__YES = 1;
const PILL_STATE__NO = 2;
const PILL_STATES = ["ignore", "yes", "no"];

const MISC_FILTER_VALUE__BASIC_RULES_2014 = "Basic Rules (2014)";
const MISC_FILTER_VALUE__FREE_RULES_2024 = "Free Rules (2024)";
const MISC_FILTER_VALUE__SRD_5_1 = "SRD 5.1";
const MISC_FILTER_VALUE__SRD_5_2 = "SRD 5.2";
...
class FilterItemClassSubclass extends FilterItem {
	constructor (options) {
		super(options);
...
class FilterSnapshotBaseSelectClickHandler extends RenderableCollectionSelectClickHandler {
...
/** @abstract */
class RenderableCollectionFilterSnapshotBase extends RenderableCollectionGenericRows {
	constructor (
		{
			filterBox,
			comp,
...
class RenderableCollectionSnapshotDecks extends RenderableCollectionFilterSnapshotBase {
	constructor (
		{
			filterBox,
			comp,
...
class FilterSnapshotUiTabUtils {
...
class FilterSnapshotUiTabSnapshotDecks {
	constructor (
		{
			filterBox,
			compManager,
...
class RenderableCollectionSnapshots extends RenderableCollectionFilterSnapshotBase {
	constructor (
		{
			filterBox,
			comp,
...
class FilterSnapshotUiTabSnapshots {
	constructor (
		{
			filterBox,
			compManager,
...
class FilterSnapshotUi extends BaseComponent {
...
class FilterSnapshotManager extends BaseComponent {
...
let SourceFilter$1 = class SourceFilter extends Filter {
...
SourceFilter$1._PILL_DISPLAY_MODE__AS_NAMES = 0;
SourceFilter$1._PILL_DISPLAY_MODE__AS_ABVS = 1;
SourceFilter$1._PILL_DISPLAY_MODE__AS_BOTH = 2;
SourceFilter$1._DEFAULT_META = {
	isIncludeOtherSources: false,
};
SourceFilter$1._DEFAULT_UI_META = {
	pillDisplayMode: SourceFilter$1._PILL_DISPLAY_MODE__AS_NAMES,
};
SourceFilter$1._PILL_DISPLAY_MODE_LABELS = {
	[SourceFilter$1._PILL_DISPLAY_MODE__AS_NAMES]: "As Names",
	[SourceFilter$1._PILL_DISPLAY_MODE__AS_ABVS]: "As Abbreviations",
	[SourceFilter$1._PILL_DISPLAY_MODE__AS_BOTH]: "As Names Plus Abbreviations",
};
